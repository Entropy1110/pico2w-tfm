...
/* Minimal PSA crypto configuration for provision application */
...
/* Disable PSA Crypto AEAD module (not needed for provision) */
#ifndef CRYPTO_AEAD_MODULE_ENABLED
#define CRYPTO_AEAD_MODULE_ENABLED             0
#endif

/* Disable PSA Crypto MAC module (not needed for provision) */
...
/* Disable PSA Crypto Cipher module (not needed for provision) */
#ifndef CRYPTO_CIPHER_MODULE_ENABLED
#define CRYPTO_CIPHER_MODULE_ENABLED           0
#endif

/* Disable PSA Crypto asymmetric key signature module (not needed for provision) */
#ifndef CRYPTO_ASYM_SIGN_MODULE_ENABLED
#define CRYPTO_ASYM_SIGN_MODULE_ENABLED        0
#endif

/* Disable PSA Crypto asymmetric key encryption module (not needed for provision) */
#ifndef CRYPTO_ASYM_ENCRYPT_MODULE_ENABLED
#define CRYPTO_ASYM_ENCRYPT_MODULE_ENABLED     0
#endif

/* Disable PSA Crypto key derivation module (not needed for provision) */
